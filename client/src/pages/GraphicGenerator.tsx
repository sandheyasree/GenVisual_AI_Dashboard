...
export default function GraphicGenerator() {
  ...
  const DiagramMockup = () => (
    <div className="bg-background border-2 border-border p-8 min-h-96">
      <svg viewBox="0 0 800 400" className="w-full h-auto">
        ...
        <text x="230" y="105" textAnchor="middle" fontSize="10" fontWeight="bold">
          CB1
        </text>

        {/* Motor 1 */}
        <circle cx="350" cy="100" r="25" fill="none" stroke="#e63946" strokeWidth="2" />
        <text x="350" y="105" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#e63946">
          M1
        </text>

        {/* Motor 2 */}
        <circle cx="500" cy="100" r="25" fill="none" stroke="#e63946" strokeWidth="2" />
        <text x="500" y="105" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#e63946">
          M2
        </text>

        {/* Motor 3 */}
        <circle cx="650" cy="100" r="25" fill="none" stroke="#e63946" strokeWidth="2" />
        <text x="650" y="105" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#e63946">
          M3
        </text>

        {/* PLC */}
        <rect x="200" y="200" width="80" height="60" fill="none" stroke="#1a1a1a" strokeWidth="2" />
        <text x="240" y="235" textAnchor="middle" fontSize="11" fontWeight="bold">
          PLC
        </text>

        {/* HMI */}
        <rect x="400" y="200" width="80" height="60" fill="none" stroke="#1a1a1a" strokeWidth="2" />
        <text x="440" y="235" textAnchor="middle" fontSize="11" fontWeight="bold">
          HMI
        </text>

        {/* Emergency Stop */}
        <circle cx="600" cy="230" r="20" fill="none" stroke="#e63946" strokeWidth="2" />
        <text x="600" y="235" textAnchor="middle" fontSize="9" fontWeight="bold" fill="#e63946">
          E-STOP
        </text>
  ...
  const SchematicMockup = () => (
    <div className="bg-background border-2 border-border p-8 min-h-96">
      <svg viewBox="0 0 800 400" className="w-full h-auto">
        {/* Sensors */}
        <text x="50" y="30" fontSize="12" fontWeight="bold">
          SENSORS
        </text>
        ...
        <text x="125" y="70" textAnchor="middle" fontSize="10">
          S2
        </text>

        {/* PLC Central */}
        <text x="350" y="30" fontSize="12" fontWeight="bold">
          PLC CORE
        </text>
        <rect x="300" y="50" width="100" height="80" fill="none" stroke="#e63946" strokeWidth="2" />
        <text x="350" y="95" textAnchor="middle" fontSize="11" fontWeight="bold">
          AC500
        </text>

        {/* Actuators */}
        <text x="600" y="30" fontSize="12" fontWeight="bold">
          ACTUATORS
        </text>
        <rect x="580" y="50" width="50" height="30" fill="none" stroke="#1a1a1a" strokeWidth="2" />
        <text x="605" y="70" textAnchor="middle" fontSize="10">
          A1
        </text>
        <rect x="650" y="50" width="50" height="30" fill="none" stroke="#1a1a1a" strokeWidth="2" />
        <text x="675" y="70" textAnchor="middle" fontSize="10">
          A2
        </text>

        {/* Communication */}
        <text x="350" y="200" fontSize="12" fontWeight="bold" textAnchor="middle">
          COMMUNICATION
        </text>
        <rect x="250" y="220" width="200" height="40" fill="none" stroke="#1a1a1a" strokeWidth="2" />
        <text x="350" y="245" textAnchor="middle" fontSize="10">
          ETHERNET / PROFIBUS
        </text>
  ...
  const IllustrationMockup = () => (
    <div className="bg-background border-2 border-border p-8 min-h-96 flex items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mb-6">
            View generated graphics in multiple engineering formats
          </p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 border-2 border-border bg-card mb-6">
            <TabsTrigger
              value="diagram"
              className="border-r-2 border-border data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
            >
              Diagrams
            </TabsTrigger>
            <TabsTrigger
